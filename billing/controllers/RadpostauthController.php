...
use app\models\RadpostauthSearch;
...
class RadpostauthController extends Controller
{
    ...
    {
        $searchModel = new RadpostauthSearch();
    ...
    /**
     * Displays a single Radpostauth model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Radpostauth model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Radpostauth();
    ...
    /**
     * Updates an existing Radpostauth model.
